...
<body>
    ...
    <div class="container-fluid p-0 intro-img">
        <div class=" container-fluid intro-bg-c p-5">
            <div class="container text-center p-5">
                <h1 class="display-4 text-white font-weight-bold">Financial Support</h1>
                <ul class="d-flex justify-content-center bg-transparent list-unstyled">
                    ...
                    <li class="p-2"><i class="fas fa-angle-right text-white"></i></li>
                    <li class="p-1"><a class="text-decoration-none text-success h5">Financial Support</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <!-- finanical support starts here -->
    <div class="container-fluid p-0 py-5 bg-light">
        <div class="container">
            <h1 class="text-center text-dark font-weight-bolder">Scholarship<span class="text-success"> List</span></h1>
            <div class="row m-0">
                <div class="col-12 shadow p-3 my-3 rounded">
                    <div class="row m-0">
                        <div class="col-4">
                            <h4 class="text-left">Fauji Foundation</h4>
                        </div>
                        <div class="col-8">
                            <p class="lead">These scholarships are reserved only for children of ex/present service soldiers. For detail, contact Fauji Foundation or District Armed Forces Off</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 shadow p-3 my-3 rounded">
                    <div class="row m-0">
                        <div class="col-4">
                            <h4 class="text-left">Scholarships For Azad Kashmir, Northern Areas & Other Provinces</h4>
                        </div>
                        <div class="col-8">
                            <p class="lead">Students of these areas may contact their nominated departments and follow their instructions</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 shadow p-3 my-3 rounded">
                    <div class="row m-0">
                        <div class="col-4">
                            <h4 class="text-left">Supports From Zakat Fund</h4>
                        </div>
                        <div class="col-8">
                            <p class="lead">This support can be received on the recommendation of Principal by the deserving and needy students only. It is non-refundable. However, according to shariat, it is lawful only for the students whose economic condition is worst.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 shadow p-3 my-3 rounded">
                    <div class="row m-0">
                        <div class="col-4">
                            <h4 class="text-left">Supports From Welfare Fund</h4>
                        </div>
                        <div class="col-8">
                            <p class="lead">From this fund, only deserving students are supported. The decision in this regard is taken by the committee constituted by the Principal.</p>
                        </div>
                    </div>
                </div>
            </div>
