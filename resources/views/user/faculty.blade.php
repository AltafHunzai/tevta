...
<body>
    ...
    <!-- faculty details starts here -->
    <div class="container-fluid p-0 py-5 bg-light">
        <div class="container">
            <h1 class="text-center my-3 text-dark font-weight-bolder">Prominent <span class="text-success">Faculty</span></h1>
            <div class="row m-0">
                <div class="col-12 col-md-3">
                    <img src="{{asset('assets/images/Director.jpg')}}" class="w-100 rounded">
                    <h5 class="text-center">Muhammad Afzal Khan</h5>
                    <p class="text-center my-0">Director IPD</p>
                </div>
                <div class="col-12 col-md-3">
                    <img src="{{asset('assets/images/download.jpg')}}" class="w-100 rounded">
                    <h5 class="text-center">Naeem Hussain</h5>
                    <p class="text-center my-0">MS. Computer Technology</p>
                    <p class="text-center my-0">Southeast University China</p>
                </div>
                <div class="col-12 col-md-3">
                    <img src="{{asset('assets/images/altaf.jpg')}}" class="w-100 rounded">
                    <h5 class="text-center">Altaf Hussain</h5>
                    <p class="text-center my-0">Web Developer</p>
                    <p class="text-center my-0">IPD | KIU University</p>
                </div>
                <div class="col-12 col-md-3">
                    <img src="{{asset('assets/images/shafqat.jpg')}}" class="w-100 rounded">
                    <h5 class="text-center">shafqat ali</h5>
                    <p class="text-center my-0">Assistant Director</p>
                    <p class="text-center my-0">Southeast University China</p>
                </div>
            </div>
        </div>
    </div>
    <!-- faculty details ends here -->
