    ...
    <div class="container-fluid p-0 intro-img">
        <div class=" container-fluid intro-bg-c p-5">
            <div class="container text-center p-5">
                <h1 class="display-4 text-white font-weight-bold">Service Center</h1>
                <ul class="d-flex justify-content-center bg-transparent list-unstyled">
                    ...
                    <li class="p-2"><i class="fas fa-angle-right text-white"></i></li>
                    <li class="p-1"><a class="text-decoration-none text-success h5">Service Center</a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row m-0">
                <div class="col-12 col-md-3 text-center">
                    <img src="{{asset('assets/images/lion.jpeg')}}" class="w-100">
                    <h5 class="text-center mt-3 text-dark">Lion Roar</h5>
                </div>
                <div class="col-12 col-md-3 text-center">
                    <img src="{{asset('assets/images/lion.jpeg')}}" class="w-100">
                    <h5 class="text-center mt-3 text-dark">Lion Roar</h5>
