            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav mx-auto ">
                        ...
                        <a class="nav-link pl-0 pl-md-4 pl-lg-4 font-weight-bolder mt-2 active" href="/job">Jobs&nbsp;Careers <span class="sr-only">(current)</span></a>
    ...
    <div class="container-fluid p-0 intro-img">
        <div class=" container-fluid intro-bg-c p-5">
            <div class="container text-center p-5">
                <h1 class="display-4 text-white font-weight-bold">Jobs&nbsp;Careers</h1>
                <ul class="d-flex justify-content-center bg-transparent list-unstyled">
                    ...
                    <li class="p-1"><a class="text-decoration-none text-success h5">Jobs&nbsp;Careers</a></li>
                </ul>
            </div>
        </div>
    </div>
