...
<body>
    ...
    <div class="container-fluid p-0 intro-img">
        <div class=" container-fluid intro-bg-c p-5">
            <div class="container text-center p-5">
                <h1 class="display-4 text-white font-weight-bold">Research & Publications</h1>
                <ul class="d-flex justify-content-center bg-transparent list-unstyled">
                    ...
                    <li class="p-2"><i class="fas fa-angle-right text-white"></i></li>
                    <li class="p-1"><a class="text-decoration-none text-success h5">Research & Publications</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid p-0 py-5 bg-light">
        <h1 class="text-center text-dark font-weight-bolder mb-5">Our<span class="text-success"> Publications</span></h1>
                        ...
                        <div class="cardC">
                            <div class="row">
                                <div class="col-md-4 text-center align-self-center">
                                    <img src="{{asset('assets/images/person.jpg')}}" class="w-50 text-center rounded-circle">
                                </div>
                                <div class="col-md-8">
                                    <div class="mt-5">
                                        <h2 class="text-light">Ahmed Nadeem</h2>
                                        <p class="text-light m-0 mt-1">M.Phil Mechanical Engineering</p>
                                        <p class="text-light m-0 mt-1">Govt technical Training Centre Central jail, Faisalabad</p>
                                    </div>

                                    <p class="mt-3 text-justify text-light">
                            ...
                            <div class="row ml-3">
                                <div class="col-3">
                                    <a class="carousel-control-prev" href="#demo" data-slide="prev">
                                        <i class="fa fa-arrow-left text-white border p-3"></i>
                                    </a>
                                    <a class="carousel-control-next" href="#demo" data-slide="next">
                                        <i class="fa fa-arrow-right text-white border p-3"></i>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        <div class="cardC">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="mt-5">
                                        <h2 class="text-light">Altaf Hussain</h2>
                                        <p class="text-light m-0 mt-1">M.Phil Mechanical Engineering</p>
                                        <p class="text-light m-0 mt-1">Govt technical Training Centre Central jail, Faisalabad</p>
                                    </div>
