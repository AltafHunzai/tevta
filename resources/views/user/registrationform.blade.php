...
<head>
    ...
    <title>GB Tevta Registration form</title>
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav mx-auto ">
                        ...
                        <a class="nav-link pl-0 pl-md-4 pl-lg-4 mt-2 font-weight-bolder" href="/about">About&nbsp;Us</a>
                        ...
                        <a class="nav-link pl-0 pl-md-4 pl-lg-4 mt-2 font-weight-bolder active" href="/registrationform">Enroll&nbsp;Now<span class="sr-only">(current)</span></a>
                        <a class="nav-link pl-0 pl-md-4 pl-lg-4 mt-2 font-weight-bolder" href="/contactUs">Contact&nbsp;Us</a>
    ...
    <div class="container-fluid p-0 intro-img">
        <div class=" container-fluid intro-bg-c p-5">
            <div class="container text-center p-5">
                <h1 class="display-4 text-white font-weight-bold">Tevta Enrollment Form</h1>
                <ul class="d-flex justify-content-center bg-transparent list-unstyled">
                    ...
                    <li class="p-1"><a class="text-decoration-none text-success h5">Tevta Enrollment Form</a></li>
                </ul>
            </div>
        </div>
    </div>
